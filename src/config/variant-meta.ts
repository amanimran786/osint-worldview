...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'WorldView Monitor - Real-Time Global Intelligence Dashboard',
    ...
    siteName: 'WorldView Monitor',
    shortName: 'WorldViewMonitor',
  ...
  finance: {
    ...
    url: 'https://finance.worldview.app/',
  ...
  commodity: {
    ...
    url: 'https://commodity.worldview.app/',
