...
// VITE_VARIANT=tech selects the technology-focused dashboard.
// VITE_VARIANT=full selects the geopolitical dashboard.
// VITE_VARIANT=finance selects the markets dashboard.
