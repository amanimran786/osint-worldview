...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'livenow-fox', name: 'LiveNOW from FOX', handle: '@LiveNOWFOX', fallbackVideoId: 'sUkJfR8d8oA' },
  { id: 'abc-news', name: 'ABC News', handle: '@ABCNews', fallbackVideoId: 'vA6hHk9LmN2' },
  ...
  { id: 'rt', name: 'RT', handle: '', fallbackVideoId: 'R7tV9kLmN1Q' },
  ...
  { id: 'record-news', name: 'Record News', handle: '@RecordNews', fallbackVideoId: 'X9pLmN2qRsT' },
  ...
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: 'Q2wErTyUiOp' },
  ...
  { id: 'arirang-news', name: 'Arirang News', handle: '@ArirangCoKrArirangNEWS', fallbackVideoId: 'HjK9LmN8Pq2' },
  { id: 'india-today', name: 'India Today', handle: '@indiatoday', fallbackVideoId: 'sYZtOFzM78M' },
  { id: 'abp-news', name: 'ABP News', handle: '@ABPNews', fallbackVideoId: 'A1b2C3d4E5f' },
  ...
  { id: 'rudaw', name: 'Rudaw', hlsUrl: 'https://svs.itworkscdn.net/rudawlive/rudawlive.smil/playlist.m3u8', fallbackVideoId: 'uV7wX8yZ0aB', useFallbackOnly: true },
  // Africa
  ...
  { id: 'sabc-news', name: 'SABC News', handle: '@SABCDigitalNews', fallbackVideoId: 'ZxCVbnM1234' },
  ...
  { id: 'tv5monde-info', name: 'TV5 Monde Info', handle: '@TV5MONDEInfo', fallbackVideoId: 'T9vY6mN3pQ2' },
  { id: 'nrk1', name: 'NRK1', handle: '@nrk', fallbackVideoId: 'N6rK1aB2cD3' },
  { id: 'aljazeera-balkans', name: 'Al Jazeera Balkans', handle: '@AlJazeeraBalkans', fallbackVideoId: 'J4kLmN8pQw1' },
  // Oceania
