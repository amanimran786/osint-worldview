...
const DESKTOP_RELEASES_URL = 'https://github.com/amanimran786/osint-worldview/releases';
...
export function renderPreferences(host: PreferencesHost): PreferencesResult {
  ...
  `;
  html += `<a href="/blog/" target="_blank" rel="noopener noreferrer" class="us-discussion-link">
