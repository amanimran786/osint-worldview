...
export const RUNTIME_FEATURES: RuntimeFeatureDefinition[] = [
  ...
  },
  {
    ...
    description: 'Primary targeted stock-news search provider for analysis enrichment.',
  ...
  },
  {
    ...
    description: 'Fallback targeted stock-news provider for analysis enrichment.',
  ...
  },
  {
    ...
    description: 'Additional targeted stock-news provider for analysis enrichment.',
  ...
  },
  {
    ...
    requiredSecrets: [],
    fallback: 'Stale headlines remain available before a limited per-feed recovery attempt.',
  },
  {
    id: 'aviationStack',
