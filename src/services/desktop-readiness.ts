...
export function getDesktopReadinessChecks(localBackendEnabled: boolean): DesktopReadinessCheck[] {
  ...
  return [
    ...
    { id: 'summaries', label: 'Summaries (provider-backed or browser fallback)', ready: isFeatureAvailable('aiOllama') || isFeatureAvailable('aiJarvis') || isFeatureAvailable('aiGroq') || isFeatureAvailable('aiOpenRouter') },
