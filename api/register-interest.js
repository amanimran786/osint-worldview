          ...
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 600px; margin: 0 auto; background: #0a0a0a; color: #e0e0e0;">
            ...
            <div style="padding: 40px 32px 0;">
              <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto 32px;">
                <tr>
                  ...
                  <td style="padding-left: 12px;">
                    <div style="font-size: 16px; font-weight: 800; color: #fff; letter-spacing: -0.5px;">WORLDVIEW</div>
                    <div style="font-size: 10px; color: #666; text-transform: uppercase; letter-spacing: 2px;">Realtime intelligence platform</div>
                  </td>
                </tr>
              </table>
              ...
              <div style="text-align: center; margin-bottom: 36px;">
                <a href="https://worldview.app" style="display: inline-block; background: #4ade80; color: #0a0a0a; padding: 14px 36px; text-decoration: none; font-weight: 800; font-size: 13px; text-transform: uppercase; letter-spacing: 1.5px; border-radius: 2px;">Explore the Free Dashboard</a>
            ...
            <div style="border-top: 1px solid #1a1a1a; padding: 24px 32px; text-align: center;">
              <div style="margin-bottom: 16px;">
                <a href="https://worldview.app" style="color: #666; text-decoration: none; font-size: 12px; margin: 0 12px;">Dashboard</a>
                <a href="https://worldview.app/blog/" style="color: #666; text-decoration: none; font-size: 12px; margin: 0 12px;">Blog</a>
